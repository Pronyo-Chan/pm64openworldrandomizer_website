...
class Seed:
    ...
    def __init__(self, SeedID: str, StarRodModVersion: int, AlwaysSpeedySpin: str, AlwaysISpy: bool, AlwaysPeekaboo: bool, HiddenBlockMode: int, \
        ...
        PartnersInDefaultLocations: bool, PartnersAlwaysUsable: bool, StartWithRandomPartners: bool, WriteSpoilerLog: bool, \
        ...
        StartingMap: int = 0x00010104, StartingMaxHP: int = 10, StartingMaxFP: int = 5, StartingMaxBP: int = 3, StartingStarPower: int = 0, StartingItem0: int = 0, StartingItem1: int = 0, StartingItem2: int = 0, StartingItem3: int = 0, \
        ...
        FoliageItemHints = False, NoHealingItems =  False, StartWithRandomItems: bool = False, RandomItemsMin: int = 0, RandomItemsMax: int = 0, AddItemPouches = False, \
        RandomChoice: bool = False, MysteryRandomPick: bool = False, ItemTrapMode: int = 0, AllowItemHints: bool = True):
        ...
        #Visuals are set to default, as they are set post-generation
        self.Box5ColorA = 0xEBE677FF
        self.Box5ColorB = 0x8E5A25FF
        self.RandomCoinColor = False
        self.CoinColor = 0        
        self.RandomText = False        
        self.RomanNumerals = False

        self.MarioSetting = 0
        self.MarioSprite = 0
        self.GoombarioSetting = 0
        self.GoombarioSprite = 0
        self.KooperSetting = 0
        self.KooperSprite = 0
        self.BowSetting = 0
        self.BowSprite = 0
        ...
        self.WattSetting = 0
        self.WattSprite = 0
        self.SushieSetting = 0
        self.SushieSprite = 0
        self.ParakarrySetting = 0
        self.ParakarrySprite = 0

        self.BossesSetting = 0
        self.NPCSetting = 0
