class Items:
    def __init__(self,gear_shuffle_mode: int, include_coins_overworld: bool, include_coins_blocks: bool, include_coins_favors: bool, include_coins_foliage: bool,
        ...
        include_shops: bool, key_items_outside_dungeon: bool, shuffle_blocks: bool, shuffle_items: bool, rip_cheato_items_in_logic: bool, progression_on_rowf: int, progression_on_merlow: bool,
    ):
