class Items:
    def __init__(self,gear_shuffle_mode: int, spirit_shuffle_mode: int, include_coins_overworld: bool, include_coins_blocks: bool, include_coins_favors: bool, include_coins_foliage: bool,
